...
// ./index.js dispatches by name. Adding a new provider means filling in one
// adapter file without touching server.js or other providers.
//
// flowType discriminant in initConnect() is the key abstraction: Teller uses
// an in-page modal popup; SaltEdge uses a full-page redirect to its hosted
// widget. The frontend branches on flowType, not provider name.
 ...
 * @property {string} provider    "teller" | "saltedge"
 ...
 * @property {string} id
 * @property {"teller"|"saltedge"|"plaid_legacy"} provider
