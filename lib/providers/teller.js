...
function normalizeTransaction(t, account) {
  ...
  // Filter non-spend movements early, before storing. These are internal money
  // movements (paying a credit card, transferring between own accounts, salary
  // deposits) that aren't real spending.
  if (isNonSpendMovement(t, account, signed)) return null;
